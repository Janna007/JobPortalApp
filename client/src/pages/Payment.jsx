...
function Payment() {
  ...
  const handlePlanSelect = (plan) => {
    ...
    // Redirect to checkout or open a modal with payment options
  ...
  return (
    <div>
      ...
      <button onClick={() => handlePlanSelect('basic')}>Basic Plan</button>
      <button onClick={() => handlePlanSelect('premium')}>Premium Plan</button>
    </div>
  );
}
